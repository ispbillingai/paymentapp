...
foreach (['portal_users', 'portal_email_verifications'] as $table) {
...
Db::run("INSERT INTO portal_users (email,password_hash,status,created_at) VALUES ('new@example.test','hash','pending',NOW())");
