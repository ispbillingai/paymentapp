(function () {
  ...
  countries.forEach(function (item) {
    ...
    if (item[0] === 'ke') { option.disabled = true; option.textContent += ' — not available'; }
